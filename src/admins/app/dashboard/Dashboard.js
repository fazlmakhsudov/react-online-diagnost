...
export default class Dashboard extends Component {
  ...
  componentDidMount(){
    ...
    this.setState({visitChartData: visitData, impressionChartData:impressionData, conversionChartData:conversionData, salesStatisticsChartData:salesStatisticsData, netProfitChartData:netProfitData, totaltransactionChartData:totaltransactionData} )
  }
        ...
        <div className="row page-title-header">
          <div className="col-12">
            <div className="page-header">
              <h4 className="page-title">Dashboard F</h4>
          ...
          <div className="col-md-12">
            <div className="page-header-toolbar">
              ...
              <div className="sort-wrapper justify-content-between">
                ...
                <Dropdown>
                  <Dropdown.Toggle variant="btn btn-secondary dropdown-toggle  toolbar-item ml-3" id="dropdownMenuButton2">
                    Export
                  </Dropdown.Toggle>
                  <Dropdown.Menu>
