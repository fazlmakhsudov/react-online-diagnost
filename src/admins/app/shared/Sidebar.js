        ...
        <ul className="nav">
              ...
              <Dropdown>
                ...
                <Dropdown.Menu className="preview-list navbar-dropdown">
                  ...
                  <Dropdown.Item className="dropdown-item preview-item d-flex align-items-center text-small">
                    {/* <Trans><Link to='my-cabinet.html'>My cabinet</Link></Trans> */}
                    <a class="dropdown-item" href="my-cabinet.html">My cabinet 4</a>
                  </Dropdown.Item>
          ...
          <li className={ this.isPathActive('/user-pages') ? 'nav-item active' : 'nav-item' }>
            <div className={ this.state.userPagesMenuOpen ? 'nav-link menu-expanded' : 'nav-link' } onClick={ () => this.toggleMenuState('userPagesMenuOpen') } data-toggle="collapse">
              ...
              <span className="menu-title"><Trans>Patient Pages</Trans></span>
              <i className="menu-arrow"></i>
            </div>
